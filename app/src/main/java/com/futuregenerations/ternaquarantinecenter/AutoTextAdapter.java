...
public class AutoTextAdapter extends ArrayAdapter<Patients> {

    private Context context;
    private List<Patients> patientsDataList;
    List<Patients> suggestions;

    public AutoTextAdapter(@NonNull Context context, @NonNull List<Patients> dataList) {
    ...
    private Filter filter = new Filter() {
        ...
        public CharSequence convertResultToString(Object resultValue) {
            return ((Patients) resultValue).getName();
        }
    };
}
